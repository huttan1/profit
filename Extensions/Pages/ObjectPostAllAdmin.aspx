<%@ Page Language="C#" CodeFile="ObjectPostAllAdmin.aspx.cs" MasterPageFile="~/Extensions/Pages/Common/ObjectPostBase1.master" Inherits="Extensions.Pages.ObjectPostAdmin" %>
...
<asp:Content ContentPlaceHolderID="LitiumStudioContentHeading" runat="server">
	...
	<Foundation:SystemString Name="extensions_op_settings_subheader_list_all" runat="server"/>
</asp:Content>
