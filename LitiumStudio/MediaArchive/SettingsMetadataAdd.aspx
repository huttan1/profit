<%@ page language="C#" masterpagefile="~/LitiumStudio/Framework/ControlPanel.master" autoeventwireup="true" inherits="LitiumStudio_MediaArchive_SettingsMetadataAdd, Litum.Studio.Web" %>
...
<asp:Content ID="Content5" ContentPlaceHolderID="LitiumStudioContentHeading" runat="Server">
    <span><Foundation:ModuleString Name="MetaDataCreatePageSubHeader1" runat="server" ID="Systemstring1"/></span><span class="litContentTopGuide">&nbsp;(<Foundation:ModuleString Name="MetaDataCreatePageSubHeader2" runat="server" ID="Systemstring2"/>)</span>
</asp:Content>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentRight" Runat="Server">
    <div class="lsContentScroll">
	        <table border="0" cellspacing="0" cellpadding="0">
		        <tr>
			        <td colspan="2" class="litBoldText"><Foundation:ModuleString Name="Metadata" runat="server" ID="Systemstring4"/>:<img src="images/transparent.gif" style="vertical-align:middle;" class="litIconRequired" alt="" /></td>
		        </tr>
		        <tr>
