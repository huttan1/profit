<%@ page language="C#" masterpagefile="~/LitiumStudio/ProductCatalog/Framework/Base.master" autoeventwireup="true" inherits="LitiumStudio_ProductCatalog_BatchEditArticle, Litum.Studio.Web" validaterequest="false" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ToolbarRight" runat="Server">
	<Toolbar:HorizontalToolbar ToolbarIndex="1" ID="c_toolbarRight" runat="server">
		<Toolbar:ToolbarItem DisabledClass="litToolbarItem litToolbarItemDisabled" Class="litToolbarItem"
			...
			ImageURL="Images/transparent.gif" ID="c_toolbarItemBack" OnClick="ToolbarItemAbort_Click"
			runat="server" />
	</Toolbar:HorizontalToolbar>
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="LitiumStudioContentHeading" runat="Server">
	<div style="float: left">
		<img src="Images/transparent.gif" class="litIconVariant" alt="" runat="server" id="c_imageIcon" />
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentRight" runat="Server">
	<Telerik:RadScriptBlock ID="RadScriptBlock2" runat="server">
		<script type="text/javascript">
			function openProductWin() {
				var url = '<%=Page.ResolveUrl("~/LitiumStudio/ProductCatalog/Framework/SelectArticles.aspx")%>?TemplateID=<%=TemplateID %>&AllArticleFieldID=<%=c_allArticleIDs.ClientID %>';
	...
	<div class="lsContentNoScroll">
		...
		<Telerik:RadWindowManager ID="RadWindowManager1" IconUrl="~/LitiumStudio/Images/icons_standard/product_group_16px.png"
			...
			Modal="true" Width="650" Height="550" Behaviors="Close" Skin="Vista" KeepInScreenBounds="true">
			<Windows>
