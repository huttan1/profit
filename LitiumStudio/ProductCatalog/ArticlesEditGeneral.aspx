<%@ page language="C#" masterpagefile="~/LitiumStudio/ProductCatalog/Framework/ArticlesEditBase.master" autoeventwireup="true" validaterequest="false" inherits="LitiumStudio_ProductCatalog_ArticlesEditGeneral, Litum.Studio.Web" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="PageHeader" Runat="Server">
        <img src="Images/transparent.gif" class="litIconArticle" alt="" /><Foundation:ModuleString ID="ModuleString4" Name="ArticlesEditGeneralHeader" Runat="server"/>
</asp:Content>
                        ...
                        <ItemTemplate>
                            <tr>
                                <td valign="top" style="width:120px;">
                                    ...
                                    <asp:Label id="articleNumberInput" cssclass="litInputText" enabled="false" style="width:107px;" runat="server" />
                                </td>
                                <asp:Repeater id="c_articlePropertiesRepeater" runat="server" OnItemDataBound="ArticlePropertiesRepeater_OnItemDataBound" OnItemCommand="RepeaterItemCommand">
                                    <ItemTemplate>
                                       <td valign="top" runat="server" id="c_tableCell" style="width:187px; border-left:1px solid white; padding-bottom:5px;">
										   ...
										   <asp:Panel runat="server" id="panelVariantField" cssclass="litListContent" style="font-weight:normal;font-style:italic;" visible="false"><Foundation:ModuleString ID="ModuleString3" Name="VariantField" Runat="server"/></asp:Panel>
                                        </td>
                                    </ItemTemplate>
                                </asp:Repeater>
