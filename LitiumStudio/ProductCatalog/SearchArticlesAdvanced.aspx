<%@ page language="C#" debug="true" masterpagefile="~/LitiumStudio/ProductCatalog/Framework/Base.master" autoeventwireup="true" inherits="LitiumStudio_ProductCatalog_SearchArticlesAdvanced, Litum.Studio.Web" %>
            ...
            <ComponentArt:TreeView id="TreeView1"
                    ...
                    <ComponentArt:NavigationCustomTemplate id="ArticleHeaderTemplate">
                        <Template>
                            <table cellpadding="0" cellspacing="0" border="0" class="litTreeNodeTable">
                                <tr>
                                    <th class="litText" align="left" style="width:105px;"><Foundation:ModuleString ID="ModuleString3" Name="ArticleNumber" Runat="server"/></th>
                                    ...
                                    <th class="litText" align="center" style="width:120px;"><Foundation:ModuleString ID="ModuleString11" Name="IncludeInVariant" Runat="server"/></th>
                ...
                <ClientTemplates>
                    <ComponentArt:ClientTemplate id="ArticleTemplate">
                            <table cellpadding="0" cellspacing="0" border="0" class="litTreeNodeTable">
                                <tr>
                                    <td class="litText" align="left" style="width:105px;">## DataItem.GetProperty('Artikelnummer') ##</td>
                                    ...
                                    <td class="litText" align="center" style="width:120px;">## DataItem.GetProperty('Variant') ##</td>
