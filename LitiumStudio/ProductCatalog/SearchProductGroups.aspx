<%@ page language="C#" debug="true" masterpagefile="~/LitiumStudio/ProductCatalog/Framework/Base.master" autoeventwireup="true" inherits="LitiumStudio_ProductCatalog_SearchProductGroups, Litum.Studio.Web" %>
    ...
    <div class="litModuleContentWithTreeMainAreaV2">
        ...
        <div class="litModuleContentWithTreeMainUnderTabAreaV2 litUnderTabArea">
            <ComponentArt:TreeView id="TreeView1"
                    ...
                    <ComponentArt:NavigationCustomTemplate id="HeaderTemplate">
                        <Template>
                            <table cellpadding="0" cellspacing="0" border="0" class="litTreeNodeVariantsTable">
                                <tr>
                                    <th class="litText" align="left" style="width:220px; padding-left:5px;"><Foundation:ModuleString ID="ModuleString2" Name="Term" Runat="server"/></th>
                                    <th class="litText" align="left" style="width:80px;"><Foundation:ModuleString ID="ModuleString9" Name="Status" Runat="server"/></th>
                                    <th class="litText" align="center" style="width:80px;"><Foundation:ModuleString ID="ModuleString10" Name="Published" Runat="server"/></th>
                                    <th class="litText" align="center" style="width:160px;"><Foundation:ModuleString ID="ModuleString11" Name="Unpublished" Runat="server"/></th>
                ...
                <ClientTemplates>
                    <ComponentArt:ClientTemplate id="ProductGroupTemplate">
                            <table cellpadding="0" cellspacing="0" border="0" class="litTreeNodeVariantsTable">
                                <tr>
                                    <td class="litText" align="left" style="width:220px; padding-left:5px;" title="/ ## DataItem.GetProperty('FullPath') #### DataItem.GetProperty('Term') ##">/ ## DataItem.GetProperty('Path') ##<b>## DataItem.GetProperty('Term') ##</b></td>
                                    <td class="litText" align="left" style="width:80px;">## DataItem.GetProperty('Status') ##</td>
                                    <td class="litText" align="center" style="width:80px;">## DataItem.GetProperty('Published') ##</td>
                                    <td class="litText" align="center" style="width:160px;">## DataItem.GetProperty('Unpublished') ##</td>
                                    <td class="litText" align="left" style="width:210px;">## DataItem.GetProperty('Template') ##</td>
                                </tr>
                            </table>
                    </ComponentArt:ClientTemplate>
                    <ComponentArt:ClientTemplate id="ProductGroupInfo">
                            <table cellpadding="0" cellspacing="0" border="0" style="margin-left:8px;width:expression((document.documentElement.clientWidth || document.body.clientWidth) - 285 + 'px');">
                                <tr>
                      ...
                      <ComponentArt:ClientTemplate id="ErrorTemplate">
                            <table cellpadding="0" cellspacing="0" border="0" style="width:expression((document.documentElement.clientWidth || document.body.clientWidth) - 285 + 'px');">
                                <tr>
