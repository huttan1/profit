<%@ page language="C#" masterpagefile="~/LitiumStudio/ProductCatalog/Framework/Base.master" autoeventwireup="true" inherits="LitiumStudio_ProductCatalog_ArticleGroupEdit, Litum.Studio.Web" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="LitiumStudioContentHeading" Runat="Server">
     <img src="Images/transparent.gif" class="litIconArticleGroup" alt="" />
        <Foundation:ModuleString ID="ModuleString1" Name="Edit" Runat="server"/>&nbsp;
        "<asp:Label runat="server" ID="c_labelArticleGroupName" />"    
</asp:Content>
					...
					<asp:Repeater runat="server" ID="NameRepeater">
						<ItemTemplate>
							<div style="float: left; padding-right: 10px;">
								...
								<asp:TextBox runat="server" CssClass="litInputText770" MaxLength="400" ID="c_name"
									Text='<%#Eval("Name") %>' />
