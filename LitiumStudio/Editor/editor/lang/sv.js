...
VisitLink			: "Öppna länk",	// Changed by Litium
Anchor				: "Infoga/Redigera ankarlänk",
// AnchorDelete		: "Radera ankarlänk", Changed by Litium
AnchorDelete        : "Ta bort ankarlänk", 
InsertImageLbl: "Bild",
...
Style				: "Anpassad stil",
// FontFormat			: "Teckenformat", Changed by Litium
FontFormat          : "Styckeformat",
Font				: "Typsnitt",
FontSize			: "Storlek",
TextColor			: "Textfärg",
...
RowCM				: "Rad",
ColumnCM			: "Kolumn",
// InsertRowAfter		: "Lägg till Rad Efter", Changed by Litium
InsertRowAfter: "Infoga rad efter", 
// InsertRowBefore		: "Lägg till Rad Före", Changed by Litium
InsertRowBefore     : "Infoga rad före", 
DeleteRows			: "Radera rad",
// InsertColumnAfter	: "Lägg till Kolumn Efter",  Changed by Litium
InsertColumnAfter   : "Infoga kolumn efter", 
// InsertColumnBefore	: "Lägg till Kolumn Före", Changed by Litium
InsertColumnBefore: "Infoga kolumn före", 
DeleteColumns: "Radera kolumn",
// InsertCellAfter		: "Lägg till Cell Efter", Changed byLitium
InsertCellAfter     : "Infoga cell efter", 
// InsertCellBefore: "Lägg till Cell Före", Changed by Litium
InsertCellBefore: "Infoga cell före", 
DeleteCells: "Radera celler",
MergeCells			: "Sammanfoga celler",
// MergeRight			: "Sammanfoga Höger", Changed by Litium
MergeRight: "Sammanfoga celler åt höger",
// MergeDown: "Sammanfoga Ner", Changed by Litium
MergeDown: "Sammanfoga celler neråt",
// HorizontalSplitCell	: "Dela Cell Horisontellt", Changed by Litium
HorizontalSplitCell: "Dela celler vågrätt",
// VerticalSplitCell	: "Dela Cell Vertikalt", Changed by Litium
VerticalSplitCell: "Dela celler lodrätt", 
...
// FontFormats			: "Normal;Formaterad;Adress;Rubrik 1;Rubrik 2;Rubrik 3;Rubrik 4;Rubrik 5;Rubrik 6;Normal (DIV)", Changed by Litium
FontFormats         : "Normal;Rubrik 1;Rubrik 2;Rubrik 3",
...
DlgImgUnlockRatio   : "Lås upp höjd/bredd förhållanden", // Added by Litium
...
// Templates Dialog
// Templates			: "Sidmallar", Changed by Litium
Templates           : "Innehållsmallar",
// DlgTemplatesTitle: "Sidmallar", Changed by Litium
DlgTemplatesTitle   : "Innehållsmallar",
// DlgTemplatesSelMsg: "Var god välj en mall att använda med editorn<br>(allt nuvarande innehåll raderas):", Changed by Litium
DlgTemplatesSelMsg: "Välj en mall att använda med editorn.<br>OBS! Denna åtgärd går inte att ångra!",
DlgTemplatesLoading: "Laddar mallar. Var god vänta...",
// DlgTemplatesNoTpl	: "(Ingen mall är vald)", Changed by Litium
DlgTemplatesNoTpl   : "(Inga mallar finns skapade)",
// DlgTemplatesReplace: "Ersätt aktuellt innehåll", Changed by Litium
DlgTemplatesReplace: "Ersätt befintligt innehåll",
