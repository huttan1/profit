<%@ page language="C#" autoeventwireup="true" inherits="FCKeditor_editor_plugins_NewsletterImageUpload_NewsletterImageUpload, Litum.Studio.Web" %>
...
<head runat="server">
    ...
    function validate_empty_file_name() {
        var file_textBox = document.getElementById("file");
        if (file_textBox.value == "") {
            alert('Select the image, please');
            return false;
        }
        return true;
    }
...
<body style="overflow: hidden;">
	...
	<div id="divUpload" style="display: none">
        ...
        <input id="file" type="file" size="100" name="file"><br /><br />        

        <div style="float:right;">
            <input id="c_buttonSave" onserverclick="ButtonSave_Click" onclick="if(!validate_empty_file_name()) return false;" type="button" value="Send it to the Server" fcklang="ImageUploadBtn" runat="server"/>
        </div>
	</div>
                ...
                <td style="padding-left:10px; padding-bottom:10px; width:210px;" valign="top">
                    <fieldset style="width:195px; height:370px; padding:5px; padding-right:0px;"><legend class="litBoldText"><asp:Label runat="server" ID="c_labelFoldersCategories"></asp:Label>&nbsp;&nbsp;</legend>
                        <div style="width:188px; height:360px; overflow:auto; margin-top:5px;">
							            ...
							            <TreeView:AdminTreeView width="100%" height="100%" Runat="server" id="c_treeView" ShowArchive="False" ShowTrashcan="False"  ImagesBaseUrl="~/LitiumStudio/Images/icons_standard/"/>
                                    </div>
					            </fieldset><img src="<%=Page.ResolveUrl("~/LitiumStudio/Newsletter/images/transparent.gif")%>" width="205" height="1" />
                </td>
                    ...
                    <fieldset runat="server" id="m_fileUploadFieldSet" style="width:390px; height:53px; margin-top:5px;padding:5px; padding-left:10px; padding-right:5px;" visible="false"><legend class="litBoldText"><asp:Label ID="_lableUpload" runat="server" />&nbsp;&nbsp;</legend>
                        <div style="width:387px; height:44px; overflow:auto;">
	                        ...
	                        <div style="float:right;">
				                ...
				                <img src="<%=Page.ResolveUrl("~/LitiumStudio/Newsletter/images/transparent.gif")%>" width="390" height="1" />
                </td>
            </tr>
        </table>
