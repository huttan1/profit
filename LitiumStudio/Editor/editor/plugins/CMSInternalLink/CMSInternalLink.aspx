<%@ page language="C#" autoeventwireup="true" inherits="FCKeditor_editor_plugins_CMSInternalLink_CMSInternalLink, Litum.Studio.Web" %>
...
<head runat="server">
    <title><Foundation:ModuleString Name="InternalLink" runat="server"/></title>
...
<script type="text/javascript" language="javascript">
	...
	function IsSelected() {
    	...
    	var uploadControlValue = uploadControl.value;
    	if (uploadControlValue == '') {
    ...
    <div id="divInfo" style="DISPLAY: none;">
			...
			<div id="divLinkTypeUrl">
				<table cellspacing="0" cellpadding="0" width="100%" border="0" dir="ltr">
					...
					<tr>
						<td colspan="3"><input type="checkbox" checked="checked" id="checkboxAttachment" onchange="OnUrlAttachmentChanged();" /> <Foundation:SystemString runat="server" Name="EditorAttachAsAttachment" /></td>
					</tr>
				</table>
				<br />
		...
		<asp:ScriptManager ID="ScriptManager" runat="server" />
		 <div id="divFileUpload" style="display: none">
            ...
            <div style="float:right;">
                <input id="c_buttonSave" onclick="if(!IsSelected()) return false;" onserverclick="ButtonSave_Click" type="button" value="Send it to the Server" fcklang="FileUseBtn" runat="server"/>
            </div>
	    </div>
	    <div id="divUpload" style="DISPLAY: none;overflow: auto;" class="litModuleTreeAreaV2 litText">	        
                <TreeView:TreeView id="c_treeView"
	                HoverNodeCssClass="HoverTreeNode" runat="server" SelectedNodeCssClass="SelectedTreeNode"
		                ...
		                <table cellpadding="0" cellspacing="0" border="0" width="100%" style="border: 1px solid #A19E98; background-color:#FFFFFF;">
			                <tr>
				                <td style="padding:5px; padding-left:10px; padding-bottom:0px;" width="200" valign="top">
					                <fieldset style="width:200px; height:240px; padding:5px; padding-right:0px;"><legend class="litBoldText"><Foundation:ModuleString ID="ModuleString1" Name="FoldersCategories" runat="server" />&nbsp;&nbsp;</legend>
					                ...
					                </fieldset><img src="<%=Page.ResolveUrl("~/LitiumStudio/CMS/images/transparent.gif")%>" width="200" height="1" />
					            </td>
				                <td style="padding:5px; padding-bottom:0px;" valign="top" width="100%">
					                <fieldset style="width:378px; height:240px; padding:5px; padding-right:0px;"><legend class="litBoldText"><Foundation:ModuleString ID="ModuleString2" Name="Files" runat="server" />&nbsp;&nbsp;</legend>
						                <div style="width:363px; height:225px; overflow:auto; margin-top:5px;">
							                <asp:Repeater ID="c_repeaterList" Runat="server" OnItemDataBound="RepeaterList_OnItemBound">
								                <ItemTemplate>
									                <table id="itemTable" runat="server" cellpadding="0" cellspacing="0" border="0" class="litImageList" onMouseOut="listRow_onMouseOut(this);" onMouseOver="listRow_onMouseOver(this);" onClick="listRow_onClick(this);">
										                <tr>
											                ...
											                <td valign="top" width="100%"><asp:Label id="labelName" Font-Bold="true" Runat="server"/><br /><asp:Label id="labelInfo" Runat="server"/><asp:DropDownList ID="dropDownListVersions" style="margin-left:10px;" Visible="false" runat="server" /></td>
										                </tr>
									                </table>
								                </ItemTemplate>
							                </asp:Repeater>
