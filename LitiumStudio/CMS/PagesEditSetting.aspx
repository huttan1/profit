<%@ page language="C#" validaterequest="false" autoeventwireup="true" maintainscrollpositiononpostback="true" inherits="LitiumStudio_CMS_PagesEditSetting, Litum.Studio.Web" %>
	    ...
	    <table cellpadding="0" cellspacing="0" border="0"  style="width:100%;">
		    <tr>
			    ...
			    <td valign="top" class="litInputRightArea">
				   ...
				   <Pages:PropertyList id="c_propertyList" IsContentProperties="false" runat="server">
			            <BooleanTemplate>
						                        ...
						                        <table cellpadding="0" cellspacing="0" border="0" width="100%" class="litInputTable">
							                        <tr>
								                        <td style="width:100%;">
															...
															<Pages:LitCustomValidator id="validatorMandatoryRelationBaseTemplate" cssClass="litErrorMsg" Display="Dynamic" runat="server"/>
					            ...
					            <ShortStringItemTemplate>
						            <table cellpadding="0" cellspacing="0" border="0" width="100%">
						                <tr id="trShortStringPropertyName" runat="server" style="padding-bottom: 0px !important;">
						                    ...
						                    <td><asp:Label id="labelShortStringPropertyName" CssClass="litBoldText" runat="server"/><asp:Image ImageUrl="~/LitiumStudio/CMS/Images/transparent.gif" id="imgShortStringMandatory" CssClass="litIconRequired" AlternateText="" ImageAlign="AbsMiddle" runat="server"/><Pages:LitCustomValidator id="validatorMandatoryShortString" cssClass="litErrorMsg" Display="Dynamic" runat="server"/><asp:ImageButton id="imageButtonShortStringDeleteProperty" ImageUrl="~/LitiumStudio/CMS/Images/transparent.gif" ImageAlign="AbsMiddle" BorderWidth="0" cssclass="litIconDelete" runat="server"/></td>
						                </tr>
						                <tr>
						                    <td style="padding-left:0px; width:50%; padding-right: 0px !important;" id="tdOriginalShortString" runat="server">
						                        <table cellpadding="0" cellspacing="0" border="0" width="100%" class="litInputTable">
							                        <tr>
								                        <td valign="middle"><asp:Label id="labelOriginalShortString" CssClass="litText" runat="server"/></td>
								                        <td style="width:100%; margin: 10px 10px 10px 10px;"><asp:TextBox id="textBoxOriginalShortString" CssClass="litInputFullWidth" Enabled="false" ReadOnly="true" runat="server"/></td>
								                        <td style="width:16px;" valign="top"><div class="litBlankAddDelete" /></td>
						                                <td style="width:16px;" valign="top"><div class="litBlankAddDelete" /></td>
							                        </tr>
						                        </table>
						                    ...
						                    <td> 
						                        <table cellpadding="0" cellspacing="0" border="0" width="100%" class="litInputTable">
							                        <tr>
								                        ...
								                        <td style="width:16px;" valign="top"><asp:panel id="panelLinkInternalRemove" CssClass="litBlankAddDelete" runat="server"/><asp:ImageButton id="imageButtonLinkInternalRemove" ImageUrl="~/LitiumStudio/CMS/Images/transparent.gif" ImageAlign="AbsMiddle" BorderWidth="0" cssclass="litIconDelete" runat="server"/></td>
						                    ...
						                    <td style="padding-left:0px; width:50%; padding-right: 0px !important;" id="tdOriginalLongStringSimple" runat="server">
						                        <table cellpadding="0" cellspacing="0" border="0" width="100%" class="litInputTable">
							                        <tr>
								                        ...
								                        <td style="width:100%; margin: 10px 10px 10px 10px;"><asp:TextBox id="textBoxOriginalLongStringSimple" CssClass="litInputFullWidth" textMode="multiline" Rows="10" ReadOnly="true" Enabled="false" runat="server"/></td>
								                        <td style="width:16px;" valign="top"><div class="litBlankAddDelete" /></td>
						                                <td style="width:16px;" valign="top"><div class="litBlankAddDelete" /></td>
							                        </tr>
						                        </table>
						                    ...
						                    <td>   
						                        <table cellpadding="0" cellspacing="0" border="0" width="100%" class="litInputTable">
							                        <tr>
								                        ...
								                        <td style="width:100%;"><asp:TextBox id="textBoxLongStringSimple" CssClass="litInputTextArea litInputFullWidth" textMode="multiline" Rows="10" runat="server"/></td>
						                        ...
						                        <table cellpadding="0" cellspacing="0" border="0" width="100%" class="litInputTable">
							                        <tr>
								                        ...
								                        <td style="width:100%">                                                         
								                            ...
								                            <TreeView:AdminTreeView width="300" Runat="server" ShowCategories="false" id="c_mediaArchiveFolderTreeViewOriginal" ShowArchive="False" ShowTrashcan="False" ImagesBaseUrl="~/LitiumStudio/Images/icons_standard/" style="position:relative; padding:0px;"/>
						                        ...
						                        <table cellpadding="0" cellspacing="0" border="0" style="width: 100%; margin-bottom: 10px;" class="litInputTable">
							                        <tr>
								                        ...
								                        <td style="width:100%;">								                        
								                            ...
								                            <TreeView:AdminTreeView width="300" Runat="server" ShowCategories="false" id="c_mediaArchiveFolderTreeView" ShowArchive="False" ShowTrashcan="False" imagesbaseurl="~/LitiumStudio/Images/icons_standard/"/><input type="hidden" runat="server" id="c_hiddenSelectedFolder" style="position:relative; padding:0px;">
								                            </TreeView:AdminTreeView>
