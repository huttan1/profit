<%@ page language="C#" masterpagefile="~/LitiumStudio/CMS/Framework/Base1.master" autoeventwireup="true" inherits="LitiumStudio_CMS_PagesPermission, Litum.Studio.Web" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ToolbarRight" Runat="Server">
	<toolbar:HorizontalToolbar ToolbarIndex="1" id="c_toolbarEdit" runat="server" >
		<toolbar:ToolbarItem OnClick="ToolbarItemPermissionsAbort_Click" DisabledClass="litToolbarItem litToolbarItemDisabled" Class="litToolbarItem" LinkClass="litToolbarLink" ImageClass="litIconStop" SelectedClass="litToolbarItem litToolbarItemSelected" ImageURL="Images/transparent.gif" ID="c_toolbarItemPermissionsAbort" runat="server"/>	
		<toolbar:DividerItem ImageURL="Images/transparent.gif" Class="litToolbarSpace" runat="server" ID="Divideritem2"/>
		<toolbar:ToolbarItem OnClick="ToolbarItemPermissionsSave_Click" DisabledClass="litToolbarItem litToolbarItemDisabled" Class="litToolbarItem" LinkClass="litToolbarLink" ImageClass="litIconDiskBlue" SelectedClass="litToolbarItem litToolbarItemSelected" ImageURL="Images/transparent.gif" ID="c_toolbarItemPermissionsSave" runat="server"/>	
    </toolbar:HorizontalToolbar>
</asp:Content>

<asp:Content ID="Content5" ContentPlaceHolderID="LitiumStudioContentHeading" runat="Server">
	<img src="Images/transparent.gif" alt="" class="litIconEarthPreferences" />
	<Foundation:ModuleString ID="ModuleString16" name="PermissionHeader" runat="server" />
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentRight" Runat="Server">
	<Telerik:RadScriptBlock ID="RadScriptBlock1" runat="server">
		<script type="text/javascript">
			...
			var submitObject = document.getElementById("<% Response.Write(c_toolbarItemPermissionsSave.ClientID.ToString()); %>");
			var cancelObject = document.getElementById("<% Response.Write(c_toolbarItemPermissionsAbort.ClientID.ToString()); %>");
			...
			function addGridItem(rowID) {
				...
				gridItem.setValue(9, originalItem.getMember('ReadText').get_text());
				gridItem.setValue(10, originalItem.getMember('WriteText').get_text());
				gridItem.setValue(11, originalItem.getMember('PublishText').get_text());
			...
			function SetPermission(permissionType, checkBox, index) {
				...
				if (checkBox.checked) {
					if (permissionType == 0) {
						...
						row.SetValue(14, "checked");
					}
					else if (permissionType == -1) {
						row.SetValue(15, "checked");
					}
				}
				else {
					if (permissionType == 0) {
						...
						row.SetValue(14, null);
					}
					else if (permissionType == -1) {
						row.SetValue(15, null);
					}
				}
			}
		</script>
	...
	<div class="lsContentScroll">
        <table cellpadding="10" cellspacing="0" border="0" class="litModuleContentWithTreeMainSizeV2">
	        <tr>
	            <td valign="top">
                                ...
                                <ComponentArt:Grid id="c_gridExistingItems"
                                    ...
                                    <ClientTemplates>
                                        ...
                                        <ComponentArt:ClientTemplate ID="c_gridExistingItems_AddTemplate">
                                            <a href="#" onclick="addGridItem('## DataItem.ClientId ##');" title="## DataItem.GetMember('AddText').Value ##"><img src="../../LitiumStudio/Images/icons_standard/arrow_move_gray_right_16px.png" height="16px" width="16px" border="0" alt="## DataItem.GetMember('AddText').Value ##" /></a>
                                        </ComponentArt:ClientTemplate>
                                    </ClientTemplates>
                                </ComponentArt:Grid>
                            </td>
                                ...
                                <ComponentArt:Grid id="c_gridSelectedItems" 
                                    ...
                                    <Levels>
                                        <ComponentArt:GridLevel
                                            ...
                                            <Columns>
                                                <ComponentArt:GridColumn DataField="ID" Visible="false" />
                                                <ComponentArt:GridColumn DataField="Name" Width="100" />
                                                ...
                                                <ComponentArt:GridColumn AllowSorting="false" DataCellClientTemplateId="c_gridSelectedItems_Recursive" DataType="System.Boolean" ColumnType="CheckBox" Align="Left" />
                                                <ComponentArt:GridColumn DataField="DeleteText" visible="false"/>
                                                ...
                                                <ComponentArt:GridColumn DataField="RecursiveChecked" Width="50" Align="Center" Visible="false" />
                                    ...
                                    <ClientTemplates>
                                        ...
                                        <ComponentArt:ClientTemplate ID="c_gridSelectedItems_Recursive">
                                            <input type="checkbox" ## DataItem.GetMember('RecursiveChecked').Value ## ## DataItem.GetMember('Disabled').Value ## onclick="javascript:SetPermission(-1, this, '##DataItem.Index##');" />
                                        </ComponentArt:ClientTemplate>
