<%@ page language="C#" masterpagefile="~/LitiumStudio/Framework/ControlPanel.master" autoeventwireup="true" inherits="LitiumStudio_CMS_WebSitesStringCreate, Litum.Studio.Web" %>
...
<asp:Content ID="Content5" ContentPlaceHolderID="LitiumStudioContentHeading" runat="Server">
	<Foundation:ModuleString ID="ModuleString1" Name="WebSiteStringCreatePageSubHeader1" runat="server" /> "<asp:Label id="c_labelWebSiteName" runat="server" />"
</asp:Content>
