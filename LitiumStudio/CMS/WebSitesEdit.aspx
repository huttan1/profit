<%@ page language="C#" masterpagefile="~/LitiumStudio/Framework/ControlPanel.master" validaterequest="false" autoeventwireup="true" inherits="LitiumStudio_CMS_WebSitesEdit, Litum.Studio.Web" %>
...
<asp:Content ID="Content5" ContentPlaceHolderID="LitiumStudioContentHeading" runat="Server">
	<asp:Label ID="c_labelWebSiteName" Runat="server"/>
</asp:Content>
     ...
     <div class="lsContentScroll">
	        ...
	        <table border="0" cellspacing="0" cellpadding="0">
		        ...
		        <tr>
			        <td>  <ComponentArt:ComboBox
                                    ...
                                    TextBoxCssClass="txt"
                                    DropHoverImageUrl="../../LitiumStudio/Images/combobox/ddn.png"
                                    DropImageUrl="../../LitiumStudio/Images/combobox/ddn-hover.png"
	        ...
	        <table border="0" cellspacing="0" cellpadding="0">
		        ...
		        <tr>
			        ...
			        <td style="padding-left:10px;"><Pages:LitCustomValidator ID="c_validatorWebSiteName" runat="server" ControlToValidate="c_textBoxWebSiteName" OnServerValidate="ValidateWebSiteName" cssClass="litErrorMsg"/></td>
		        </tr>
	        </table><br />
	        <table border="0" cellspacing="0" cellpadding="0">
	            <tr>
	        ...
	        <table border="0" cellspacing="0" cellpadding="0">
		        ...
		        <tr>
			        ...
			        <td style="padding-left:10px;"><Pages:LitCustomValidator ID="c_validatorWebSiteBaseTemplate" runat="server" ControlToValidate="c_textBoxWebSiteBaseTemplate" OnServerValidate="ValidateWebSiteBaseTemplate" cssClass="litErrorMsg"/></td>
		        </tr>
	        </table><br />
	        <table border="0" cellspacing="0" cellpadding="0">
		        <tr>
		        ...
		        <tr>
			        ...
			        <td style="padding-left:10px;"><Pages:LitCustomValidator ID="c_validatorWebSiteDomainName" runat="server" ControlToValidate="c_textBoxDomainName" OnServerValidate="ValidateWebSiteDomainName" cssClass="litErrorMsg"/></td>
		        </tr>
	        </table><br />
	        <table border="0" cellspacing="0" cellpadding="0">
		        <tr>
			        <td colspan="2" class="litBoldText"><Foundation:ModuleString Name="GoogleAnalyticsAccountID" runat="server" ID="Modulestring4"/>:</td>
		        </tr>
		        <tr>
            ...
            <Foundation:InformationGroup ID="c_informationGroupProspectFinder" runat="server" Width="400px" HeaderTextName="ProspectFinder">
				<p style="float: left; margin-top: 15px; margin-right: 15px;">
					<Foundation:SystemString ID="ModuleString5" runat="server" Name="Username" CssClass="litText"/><br />
					<asp:TextBox runat="server" ID="c_prospectFinderUsername" CssClass="litInputText150" autocomplete="off" />
				</p>
				<p style="float: left; margin-top: 15px; margin-right: 15px;">
					<Foundation:SystemString ID="ModuleString7" runat="server" Name="Password" CssClass="litText"/><br />
