<%@ page language="C#" masterpagefile="~/LitiumStudio/Framework/ControlPanel.master" autoeventwireup="true" inherits="LitiumStudio_CMS_PageTypesTemplateCreate, Litum.Studio.Web" %>
...
<asp:Content ID="Content5" ContentPlaceHolderID="LitiumStudioContentHeading" runat="Server">
	...
	<Foundation:ModuleString ID="ModuleString1" Name="TemplateCreatePageSubHeader1" runat="server" /> "<asp:Label ID="c_labelPageTypeName" Runat="server"/>"<span class="litContentTopGuide">&nbsp;(<Foundation:ModuleString Name="TemplateCreatePageSubHeader2" runat="server" ID="Systemstring2"/>)</span>
</asp:Content>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentRight" Runat="Server">
        <div class="lsContentScroll">
			<table border="0" cellspacing="0" cellpadding="0">
				<tr>
					<td colspan="2" class="litBoldText"><Foundation:ModuleString ID="ModuleString2" Name="TemplateName" runat="server" />:</td>
				</tr>
				<tr>
			...
			<table border="0" cellspacing="0" cellpadding="0">
				<tr>
			        <td colspan="2"><span class="litBoldText"><Foundation:ModuleString Name="TemplateFileName" runat="server" ID="Systemstring3"/>:</span> <span class=litText><Foundation:ModuleString Name="TemplateFileNameTip" runat="server" ID="ModuleString4"/></span></td>
				</tr>
				<tr>
			...
			<asp:Panel id="c_panelMajorError" visible="False" runat="server"> 
				<fieldset class="litErrorFieldset"><legend class="litErrorFieldsetMsg"><img src="Images/transparent.gif" style="vertical-align:middle;" alt="" class="litIconError"/><b><Foundation:SystemString Name="UnknownError" runat="server" ID="Systemstring5"/></b></legend><img src="Images/transparent.gif" width="5" alt="" /><br />
