<%@ page language="C#" masterpagefile="~/LitiumStudio/Framework/ControlPanel.master" autoeventwireup="true" inherits="LitiumStudio_CMS_PageTypesEditContent, Litum.Studio.Web" %>
...
<asp:Content ID="Content5" ContentPlaceHolderID="LitiumStudioContentHeading" runat="Server">
	...
	<Foundation:ModuleString Name="PageTypeEditContent" runat="server" ID="Systemstring2"/> "<asp:Label ID="c_labelPageTypeItemName" Runat="server"/>"
</asp:Content>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentRight" Runat="Server">
        <div class="lsContentScroll" id="PageTypeContent">
            ...
            <div style="float:left;">
                ...
                <asp:TextBox CssClass="litInputText200" ID="c_newPropertyName" runat="server"></asp:TextBox><br />
                <asp:Panel id="c_panelNameErrorMessage" style="padding-top:7px;" visible="False" runat="server"> 
            ...
            <table cellpadding="0" border="0" cellspacing="0" style="width:950px;">
                ...
                <tr>
                    ...
                    <th colspan="3" class="lsListHeader"s>&nbsp;</th>
                </tr>
                <!-- Property values -->
                    ...
                    <ItemTemplate>
                        <tr>
                            <td style="width:140px;"> 
                                <asp:TextBox CssClass="litInputText" style="width:130px;" ID="c_propertyName" Text='<%# DataBinder.Eval(Container.DataItem,"PropertyName") %>' runat="server"></asp:TextBox>
    ...
    <script type="text/javascript">
    	var submitObject = null; //document.getElementById("<% Response.Write(c_addContentField.ClientID.ToString()); %>");
