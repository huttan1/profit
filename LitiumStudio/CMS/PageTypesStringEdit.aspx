<%@ page language="C#" masterpagefile="~/LitiumStudio/Framework/ControlPanel.master" autoeventwireup="true" inherits="LitiumStudio_CMS_PageTypesStringEdit, Litum.Studio.Web" %>
...
<asp:Content ID="Content5" ContentPlaceHolderID="LitiumStudioContentHeading" runat="Server">
	...
	<Foundation:ModuleString ID="ModuleString1" Name="PageTypeStringEditPageSubHeader1" runat="server" />: "<span class="litContentTopHeader"><asp:Label ID="c_labelPageTypeStringName" Runat="server"/></span>"
</asp:Content>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentRight" Runat="Server">
        <div class="lsContentScroll">
	        ...
	        <table border="0" cellspacing="0" cellpadding="0">
		        <tr>
			        <td colspan="2" class="litBoldText"><Foundation:ModuleString Name="PageTypeStringName" runat="server" ID="Systemstring3"/>:</td>
		        </tr>
		        <tr>
	        ...
	        <table border="0" cellspacing="0" cellpadding="0">
		        <tr>
			        <td colspan="2" class="litBoldText"><Foundation:ModuleString Name="PageTypeString" runat="server" ID="Systemstring4"/>:</td>
		        </tr>
		        <tr>
