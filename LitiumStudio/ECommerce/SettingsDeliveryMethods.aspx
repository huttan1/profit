<%@ page language="C#" masterpagefile="~/LitiumStudio/Framework/ControlPanel.master" autoeventwireup="true" inherits="LitiumStudio_ECommerce_SettingsDeliveryMethods, Litum.Studio.Web" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ToolbarRight" runat="Server">
	...
	<script type="text/javascript">
	    function addClick() {
	        document.location = '<%=UrlConstants.SETTINGS_DELIVERY_METHOD_ADD_EDIT_NAME %>';
	        return false;
	    }
	</script>
</asp:Content>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentRight" runat="Server">
	...
	<div class="lsContentNoScroll">
		<LS:GridHelperAjax runat="server" AssociatedControlID="m_deliveryMethod" ID="m_deliveryMethodHelper"
			OnNeedData="grid_NeedData" DataKeyName="ID" />
		<Telerik:RadGrid runat="server" ID="m_deliveryMethod">
			<ClientSettings>
			...
			<MasterTableView runat="server">
				<Columns>
					...
					<Telerik:GridBoundColumn DataField="VATPercentageFormattedValue" />
				</Columns>
			</MasterTableView>
		</Telerik:RadGrid>
	</div>
