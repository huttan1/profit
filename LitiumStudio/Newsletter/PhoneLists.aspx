<%@ page language="C#" masterpagefile="~/LitiumStudio/Newsletter/Framework/Base1.master" inherits="LitiumStudio_Newsletter_PhoneLists, Litum.Studio.Web" %>
	...
	<script type="text/javascript">
        ...
        {           
            if(selectedItems.length > 0)
            {
	            ...
	            window.open("AddressListsExport.aspx?FF_SelectedItemID=" + selectedItem + "&AddressListType=Phone"); 
            }
	    }
	</script>
