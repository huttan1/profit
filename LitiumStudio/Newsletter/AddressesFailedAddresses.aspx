<%@ page language="C#" masterpagefile="~/LitiumStudio/Newsletter/Framework/Base1.master" inherits="LitiumStudio_Newsletter_AddressesFailedAddresses, Litum.Studio.Web" %>
...
<asp:Content ID="Content3" runat="Server" ContentPlaceHolderID="LitiumStudioContentHeading">
    <img src="Images/transparent.gif" alt="" class="litIconCircularAddressLists" /><Foundation:ModuleString ID="ModuleString2" Name="AddressListFailedAddresses" runat="server" /> "<asp:Label runat="server" id="mc_labelListName" />"
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentRight" Runat="Server">
    <div class="lsContentScroll">
        <asp:DataList Runat="server" ID="mc_dgrdFailedAddresses">
	        <ItemTemplate>
		        <div class="litText"><%#(Container.DataItem as Litium.Foundation.Modules.Newsletter.AddressLists.AddressListMember).Email%></div>
	        </ItemTemplate>
        </asp:DataList><br />
