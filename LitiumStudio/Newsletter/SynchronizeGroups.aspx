<%@ page language="C#" masterpagefile="~/LitiumStudio/Newsletter/Framework/Base1.master" inherits="LitiumStudio_Newsletter_SynchronizeGroups, Litum.Studio.Web" %>
...
<asp:Content ID="Content3" runat="Server" ContentPlaceHolderID="LitiumStudioContentHeading">
	<img src="Images/transparent.gif" alt="" class="litIconDocumentExchange" /><Foundation:ModuleString ID="ModuleString1" Name="SynchronizeGroups" runat="server" />
</asp:Content>
