<%@ page language="C#" masterpagefile="~/LitiumStudio/Newsletter/Framework/Base1.master" inherits="LitiumStudio_Newsletter_PhoneNumbersCreate1, Litum.Studio.Web" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentRight" Runat="Server">
    <div class="lsContentScroll">
        <table border="0" cellspacing="0" cellpadding="0">
            <tr>
                <td colspan="2" class="litText"><Foundation:ModuleString ID="ModuleString2" Name="PhoneNumberCreatePage1Description1" runat="server" /><br /><br /></td>
            </tr>
            <tr>
                <td colspan="2" class="litBoldText"><Foundation:ModuleString ID="ModuleString3" Name="PhoneNumberCapital" runat="server" /></td>
            </tr>
            <tr>
