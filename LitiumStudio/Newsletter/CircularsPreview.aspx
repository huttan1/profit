<%@ page language="C#" masterpagefile="~/LitiumStudio/Newsletter/Framework/Base1.master" validaterequest="false" inherits="LitiumStudio_Newsletter_CircularsPreview, Litum.Studio.Web" %>
...
<asp:Content ID="Content5" ContentPlaceHolderID="LitiumStudioContentHeading" runat="Server">
    <img src="Images/transparent.gif" alt="" class="litIconCircularCirculars" /><asp:Label id="mc_labelSubject" Runat="server"/>
</asp:Content>
        ...
        <table border="0" cellspacing="0" cellpadding="0" style="width:100%; height:100%;">
                        <tr>
			                <td valign="top" class="litText" style="padding-bottom:5px;">
				                <b><Foundation:ModuleString ID="ModuleString1" Name="CircularSentDate" runat="server" />:</b> <asp:Label id="mc_labelSentDate" Runat="server"/><br />
			                </td>
		                </tr>
		                <tr>
		                ...
		                <tr>
			                <td valign="top" class="litText" style="padding-bottom:5px;">
				                <b><Foundation:ModuleString ID="ModuleString2" Name="CircularStatus" runat="server" />:</b> <asp:Label id="mc_labelStatus" Runat="server"/><br />
			                </td>
		                </tr>
		                <tr>
			                <td valign="top" class="litText" style="padding-bottom:5px;">
				                <b><Foundation:ModuleString Name="AddressLists" runat="server" ID="Modulestring3"/>:</b> <asp:Label id="mc_labelAddressList" Runat="server"/><br />
			                </td>
		                </tr>
		                <tr>
			                <td valign="top" style="width:100%; height:65%;" class="litText">
				                <iframe runat="server" scrolling="yes" style="width:100%; height:100%; background-color:#FFFFFF;" id="iframePreview" frameborder="1"></iframe>
			                </td>
		                </tr>
		                <tr>
		                    <td style="width:100%;">
		                        <div class="litBoldText" style="padding-top:20px;"><Foundation:ModuleString name="TextVersion" runat="server" ID="Propertyname6"/></div>
