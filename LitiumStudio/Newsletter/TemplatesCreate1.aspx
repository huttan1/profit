<%@ page language="C#" masterpagefile="~/LitiumStudio/Framework/ControlPanel.master" inherits="LitiumStudio_Newsletter_TemplatesCreate1, Litum.Studio.Web" %>
...
<img src="../Images/transparent.gif" alt="" class="litIconCircular" />
    <Foundation:ModuleString Name="TemplateCreatePageSubHeader1" runat="server" /><span class="litContentTopGuide">&nbsp;(<Foundation:ModuleString Name="TemplateCreatePageSubHeader2" runat="server"/>)</span>
</asp:Content>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentRight" Runat="Server">
    <div class="lsContentScroll">
	        <table border="0" cellspacing="0" cellpadding="0">
		        <tr>
			        <td colspan="2"><b><Foundation:ModuleString ID="ModuleString2" Name="TemplateName" runat="server" CssClass="litText" /><img src="images/transparent.gif" style="vertical-align:middle;" class="litIconRequired" alt="" />:</b></td>
		        </tr>
		        <tr>
		        ...
		        <tr>
			        <td colspan="2" style="padding-top:15px;"><b><Foundation:ModuleString Name="TemplateFileName" runat="server" ID="Systemstring3" CssClass="litText" /><img src="../images/transparent.gif" style="vertical-align:middle;" class="litIconRequired" alt="" />:</b></td>
		        </tr>
		        <tr>
			        <td>
		        ...
		        <tr>
			        <td>
			            ...
			            <div class="litText"><Foundation:ModuleString Name="TemplateImageURLDescription" runat="server" ID="Modulestring4" /></div>
			        </td>
