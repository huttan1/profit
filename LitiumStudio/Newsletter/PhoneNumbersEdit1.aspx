<%@ page language="C#" masterpagefile="~/LitiumStudio/Newsletter/Framework/Base1.master" inherits="LitiumStudio_Newsletter_PhoneNumbersEdit1, Litum.Studio.Web" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentRight" Runat="Server">
    <div class="lsContentScroll">
        <table border="0" cellspacing="0" cellpadding="0">
            ...
            <tr>
                <td colspan="2" class="litBoldText"><Foundation:ModuleString ID="ModuleString2" Name="PhoneNumberCapital" runat="server" /></td>
            </tr>
            <tr>
