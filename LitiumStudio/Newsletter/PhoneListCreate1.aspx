<%@ page language="C#" masterpagefile="~/LitiumStudio/Newsletter/Framework/Base1.master" inherits="LitiumStudio_Newsletter_PhoneListCreate1, Litum.Studio.Web" %>
    ...
    <div class="lsContentScroll">
        <table border="0" cellspacing="0" cellpadding="0">
            ...
            <tr>
                ...
                <td colspan="2" class="litBoldText"><asp:Label runat="server" AssociatedControlID="c_fromInputField" ID="label1"><Foundation:ModuleString Name="PhoneNumbersCapital" runat="server" ID="Modulestring5" /></asp:Label></td>
            </tr>
            <tr>
                <td></td>
                <td colspan="2" class="litText"><Foundation:ModuleString Name="PhoneNumberCreatePage1Description2" runat="server" ID="Modulestring4" /></td>
            </tr>
            <tr>
                <td></td>
            ...
            <tr>
                <td></td>
                <td colspan="2" class="litText"><Foundation:ModuleString Name="PhoneNumberCreatePage1Description3" runat="server" ID="Modulestring6" /></td>
            </tr>
            <tr>
                <td></td>
