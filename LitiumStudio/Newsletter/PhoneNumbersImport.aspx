<%@ page language="C#" masterpagefile="~/LitiumStudio/Newsletter/Framework/Base1.master" inherits="LitiumStudio_Newsletter_PhoneNumbersImport, Litum.Studio.Web" %>
    ...
    <div class="lsContentScroll">
        <table border="0" cellspacing="0" cellpadding="0">
            ...
            <tr>
                ...
                <td colspan="2" class="litBoldText"><asp:Label runat="server" ID="label1" AssociatedControlID="c_fromInputField"><Foundation:ModuleString Name="PhoneNumbersCapital" runat="server" ID="Modulestring5" /></asp:Label></td>
            </tr>
            <tr>
                <td></td>
                <td colspan="2" class="litText"><Foundation:ModuleString Name="PhoneNumberCreatePage1Description2" runat="server" ID="Modulestring6" /></td>
            </tr>
            <tr>
                <td></td>
            ...
            <tr>
                <td></td>
                <td colspan="2" class="litText"><Foundation:ModuleString Name="PhoneNumberCreatePage1Description3" runat="server" ID="Modulestring7" /></td>
            </tr>
            <tr>
                <td></td>
