<%@ page language="C#" masterpagefile="~/LitiumStudio/Newsletter/Framework/Base1.master" inherits="LitiumStudio_Newsletter_AddressListsCreate2, Litum.Studio.Web" %>
...
<asp:Content ID="Content3" runat="Server" ContentPlaceHolderID="LitiumStudioContentHeading">
    <img src="Images/transparent.gif" alt="" class="litIconCircularAddressLists" /><Foundation:ModuleString ID="ModuleString1" Name="AddressListCreatePageSubHeader1" runat="server" />&nbsp;<span style="font-weight:normal;">(<Foundation:ModuleString Name="AddressListCreateSteps2" runat="server" ID="Systemstring2"/>)</span>
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentRight" Runat="Server">
    ...
    function addGridItem(rowID)
    {
        ...
        gridItem.setValue(2,originalItem.getMember('DeleteText').get_text());
        gridItem.setValue(4,originalItem.getMember('AddText').get_text());
    ...
    {
        c_gridSelectedItems.sort(1, false); // Fix to avoid javscript error
	            ...
	            <td>
		           <table border="0" cellspacing="0" cellpadding="0">
                        <tr>
                            ...
                            <td>&nbsp;</td>
                            <td class="litBoldText"><Foundation:ModuleString ID="ModuleString4" Name="SynchronizedGroups" Runat="server"/>:</td>
                        </tr>
                        <tr>
                            <td valign="top">
