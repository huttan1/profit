<%@ page language="C#" masterpagefile="~/LitiumStudio/Newsletter/Framework/Base1.master" inherits="LitiumStudio_Newsletter_AddressesEdit1, Litum.Studio.Web" %>
...
<asp:Content ID="Content3" runat="Server" ContentPlaceHolderID="LitiumStudioContentHeading">
	<img src="Images/transparent.gif" alt="" class="litIconCircularAddressLists" /><asp:Label id="mc_labelAddress" runat="server"/>
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentRight" Runat="Server">
   <div class="lsContentScroll">
        <table border="0" cellspacing="0" cellpadding="0">
            <tr>
                <td colspan="2" class="litText"><Foundation:ModuleString ID="ModuleString1" Name="AddressIsMemberOfAddressList" runat="server" /> "<asp:Label id="mc_labelAddressListName" runat="server"/>".<br /><br /></td>
            </tr>
            <tr>
                <td colspan="2" class="litBoldText"><Foundation:ModuleString ID="ModuleString2" Name="EmailAddress" runat="server" /></td>
            </tr>
            <tr>
                <td><asp:TextBox cssclass="litInputText" id="mc_textBoxAddress" runat="server"/></td>
                <td style="padding-left:10px;"><asp:CustomValidator ID="mc_validatorAddress" runat="server" ControlToValidate="mc_textBoxAddress" OnServerValidate="ValidateAddress" cssClass="litErrorMsg"/></td>
            </tr>
            <tr>
                <td colspan="2" style="padding-top:15px;"><asp:CheckBox runat="server" ID="c_checkBoxUnsubscribed" CssClass="litText" /></td>
            </tr>
        </table><br />
