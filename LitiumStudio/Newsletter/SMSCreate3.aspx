<%@ page language="C#" masterpagefile="~/LitiumStudio/Newsletter/Framework/Base1.master" inherits="LitiumStudio_Newsletter_SMSCreate3, Litum.Studio.Web" %>
    ...
    <script type="text/javascript">
     ...
     <ComponentArt:ToolBar ID="ToolBar1" AutoPostBackOnSelect="true" OnItemCommand="ToolBar_ItemCommand" runat="server" CssClass="litToolbar" DefaultItemCssClass="litToolbarItemNew" DefaultItemHoverCssClass="litToolbarItemOnMouseOver" DefaultItemActiveCssClass="litToolbarItemOnMouseDown" DefaultItemDisabledCssClass="litToolbarItemDisabled" ImagesBaseUrl="~/LitiumStudio/Images/" ItemSpacing="0" UseFadeEffect="false" Orientation="Horizontal" DefaultItemImageWidth="16" DefaultItemImageHeight="16">
        <Items>
            ...
            <ComponentArt:ToolBarItem ID="SaveAndClose" ImageUrl="icons_standard/floppy_disk_blue.png"  ClientTemplateId="c_toolbarLeftTreeItemButtonTemplate"/>
            <ComponentArt:ToolBarItem ItemType="Separator" CssClass="" ImageUrl="toolbar/break.gif" ImageHeight="16" ImageWidth="2" />
            <ComponentArt:ToolBarItem ID="Previous" ImageUrl="icons_standard/arrow_left_blue_16px.png"  ClientTemplateId="c_toolbarLeftTreeItemButtonTemplate"/>
            <ComponentArt:ToolBarItem ItemType="Separator" CssClass="" ImageUrl="toolbar/break.gif" ImageHeight="16" ImageWidth="2" />
...
<asp:Content ID="Content3" runat="Server" ContentPlaceHolderID="LitiumStudioContentHeading">
    ...
    <span style="font-weight:normal;">(<Foundation:ModuleString Name="SMSCreate3Steps" runat="server" ID="Systemstring2"/>)</span>
</asp:Content>
        ...
        <table cellpadding="0" cellspacing="0" border="0" style="width: 100%;">
	        <tr>
				<td valign="top" style="padding-top:20px; padding-bottom:20px;">
				    <div class="litBoldText"><Foundation:ModuleString name="Message" runat="server" ID="Propertyname6"/></div>
					<asp:TextBox runat="server" ID="c_textContent" TextMode="MultiLine" CssClass="litInputText" Rows="8" Enabled="false" /> <asp:RequiredFieldValidator ID="c_validatorTextContent" runat="server" Display="Dynamic" ControlToValidate="c_textContent" CssClass="litErrorMsg" />
				</td>
			</tr>
			<tr runat="server" id="c_trScheduledDateTime">
                <td valign="top" style="padding-bottom:5px;">
	                <span class="litBoldText"><Foundation:ModuleString ID="ModuleString2" Name="CircularScheduled" runat="server" />:</span>
	                <asp:Label id="c_labelScheduledDateTime" CssClass="litInputText" Runat="server"/><br />
                </td>
            </tr>
            <tr>
                <td valign="top" style="padding-bottom:5px;">
	                <span class="litBoldText"><Foundation:ModuleString ID="ModuleString4" Name="NumberOfReceivers" runat="server" />:</span>
	                <asp:Label Runat="server" id="c_labelNumberOfReceivers" CssClass="litInputText"></asp:Label>
                </td>
            </tr>
            <tr>
                <td valign="top" style="padding-bottom:5px;">
	                <span class="litBoldText"><Foundation:ModuleString ID="ModuleString3" Name="PhoneLists" runat="server" />:</span>
	                <asp:Label id="c_labelAddressList" Runat="server" CssClass="litInputText"></asp:Label>
                </td>
            </tr>
			<tr>
				<td valign="top" style="padding-bottom:5px;">
				    <span class="litBoldText"><Foundation:ModuleString name="DefaultSenderName" runat="server" ID="ModuleString1"/>:</span>
					<asp:Label runat="server" ID="c_senderName" CssClass="litInputText"></asp:Label>
				</td>
			</tr>
			 <tr>
                <td valign="top" style="padding-bottom:5px;">
                    <asp:Panel ID="Panel1" runat="server" DefaultButton="mc_buttonTestSend">
	                    <b><Foundation:ModuleString Name="CircularSMSTestSendLabel" runat="server" ID="Modulestring12" CssClass="litText" /></b> <asp:CustomValidator ID="mc_validatorSenderEmail" runat="server" Display="Dynamic" ValidateEmptyText="true" ControlToValidate="mc_textBoxTestAddress" ValidationGroup="mailaddress" OnServerValidate="ValidatePhoneNumber" class="litErrorMsg" /><br />
