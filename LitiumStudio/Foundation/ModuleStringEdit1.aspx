<%@ page validaterequest="false" language="C#" masterpagefile="~/LitiumStudio/Framework/ControlPanel.master" autoeventwireup="true" inherits="LitiumStudio_Foundation_ModuleStringEdit1, Litum.Studio.Web" %>
...
<asp:Content ID="Content5" ContentPlaceHolderID="LitiumStudioContentHeading" runat="Server">
	<img src="../Images/transparent.gif" alt="" class="litIconModules" /><Foundation:SystemString Name="ModuleStringEdit1" runat="server" ID="Systemstring12"/> "<asp:Label ID="c_labelModuleStringName" Runat="server"/>" <Foundation:SystemString Name="ModuleStringEdit2" runat="server" ID="Systemstring1"/> "<asp:Label ID="c_labelModuleName" Runat="server"/>"
</asp:Content>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentRight" Runat="Server">
    <div class="lsContentScroll">
	    ...
	    <table border="0" cellspacing="0" cellpadding="0">
		    <tr>
			    <td colspan="2" class="litBoldText"><Foundation:SystemString Name="ModuleStringName" runat="server" ID="Systemstring3"/><img src="../images/transparent.gif" style="vertical-align:middle;" class="litIconRequired" alt="" />:</td>
		    </tr>
		    <tr>
	    ...
	    <table border="0" cellspacing="0" cellpadding="0">
		    <tr>
			    <td colspan="2" class="litBoldText"><Foundation:SystemString Name="ModuleString" runat="server" ID="Systemstring4"/>:</td>
		    </tr>
		    <tr>
			    <td><asp:TextBox TextMode="MultiLine" Rows="10" cssclass="litInputText" id="c_textBoxModuleStringValue" runat="server"/></td>
