<%@ page language="C#" masterpagefile="~/LitiumStudio/Relations/Framework/Base.master" autoeventwireup="true" inherits="LitiumStudio_Relations_Add5, Litum.Studio.Web" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="LitiumStudioContentHeading" Runat="Server">
        <img src="Images/transparent.gif" alt="" class="litIconRelationsPerson" /><Foundation:ModuleString ID="ModuleString2" Name="PersonAddPageHeader" runat="server" /><span class="litTextNormalWeight">&nbsp;(<Foundation:ModuleString ID="ModuleString3" Name="PersonAddPage5SubHeader" runat="server"/>)</span>
</asp:Content>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentRight" Runat="Server">
    <script type="text/javascript" src="Scripts/listBoxSelection.js"></script>
    <div class="lsContentScroll">
        <span class="litText"><Foundation:ModuleString ID="ModuleString1" Name="PersonAddPage5Description" runat="server" /><br /><br /></span>
        <table id="c_organizations" border="0" cellspacing="0" cellpadding="0" runat="server">
            <tr>
	            <td class="litBoldText"><Foundation:ModuleString Name="AvailableOrganizations" runat="server" />:</td>
	            <td>&nbsp;</td>
	            <td class="litBoldText"><Foundation:ModuleString Name="OrganizationsOfThePerson" runat="server" />:</td>
            </tr>
            <tr>
