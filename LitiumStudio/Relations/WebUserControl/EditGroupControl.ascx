<%@ control language="C#" autoeventwireup="true" inherits="LitiumStudio_Relations_WebUserControl_EditGroupControl, Litum.Studio.Web" %>
<div style="margin-top: 15px;" class="lsTabContent">
	<table border="0" cellspacing="0" cellpadding="0">
		<tr>
			<td class="litBoldHeader"><Foundation:ModuleString ID="ModuleString1" Name="AvailableGroups" runat="server" />:</td>
			<td>&nbsp;</td>
			<td class="litBoldHeader"><Foundation:ModuleString ID="ModuleString2" Name="GroupsOfThePerson" runat="server" />:</td>
		</tr>
		<tr>
