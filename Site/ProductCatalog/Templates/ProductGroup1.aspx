<%@ Page Language="C#" AutoEventWireup="true" CodeFile="~/Site/ProductCatalog/Templates/ProductGroup1.aspx.cs" Inherits="Site.ProductCatalog.Templates.ProductGroup1" %>
<asp:content id="Content1" contentplaceholderid="Content" runat="Server">
<div class="productgroup grid_12">
        <div class="grid_5 alpha">
            <pc:DisplayImage runat="server" MaxHeight="300" MaxWidth="370" />
	    </div>
	    ...
	    <pc:ProductGroupRepeater runat="server" ShowEmptyGroups="true">
    		...
    		<ItemTemplate>
			    <li class="grid_2">
    				<pc:ProductGroupLink ShowEmptyGroup="true" runat="server"><pc:DisplayImage MaxWidth="130" MaxHeight="140" runat="server" /></pc:ProductGroupLink>
					<pc:ProductGroupLink ShowEmptyGroup="true" runat="server"><pc:DisplayName runat="server" /></pc:ProductGroupLink>
			    </li>
		    </ItemTemplate>
