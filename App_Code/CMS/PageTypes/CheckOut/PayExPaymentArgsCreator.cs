...
{
    /// <summary>
    /// Summary description for PayExPaymentArgsCreator
    /// </summary>
    public class PayExPaymentArgsCreator : IPaymentArgsCreator
    {
        ...
        {
            get { return typeof(PayExProvider); }
        }
        ...
        {
            PayExExecutePaymentArgs args = new PayExExecutePaymentArgs();
            ...
            if (info != null)
            {
                ...
                args.PersonNo = info.CustomerSsn;
                args.ClientLanguage = CurrentState.Current.WebSite.Culture.Name;
                args.ExecuteScript = new PayExExecutePaymentArgs.ExecuteScriptHandler(info.ExecuteScript);
